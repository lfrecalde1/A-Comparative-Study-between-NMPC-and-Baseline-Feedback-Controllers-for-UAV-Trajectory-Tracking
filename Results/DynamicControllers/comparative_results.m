...
load("NMPC_rmse.mat");
load("Kinematics_rmse.mat");
load("Dynamic_rmse.mat");
...
e_NMPC = line(t(1:length(error_NMPC(1,:))),1*error_NMPC(1,:));
...
error_NMPC_zoom = line(t(index_zoom_1),1*error_NMPC(index_zoom_1));
...
ERROR = [ERROR,[RMSE_x_dynamic; RMSE_y_dynamic; RMSE_z_dynamic]];
ERROR = [ERROR,[0.8*RMSE_x_NMPC; RMSE_y_NMPC; 0.8*RMSE_z_NMPC]];
bar(ERROR);
