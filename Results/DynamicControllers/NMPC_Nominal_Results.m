...
%% Colorbar
scatter(h(1, :),h(2, :),30,error,'filled','MarkerFaceAlpha',0.7);
c = colorbar;
...
%% Legend nomeclature
hLegend_1 = legend([hd_plot, h_plot],{'$\mathbf{\eta}_d$','$\mathbf{\eta}$'},'fontsize',10,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',1,'TextColor','black');
...
%% Colorbar
scatter(h(1, :),h(3, :),30,error,'filled','MarkerFaceAlpha',0.7);
c = colorbar;
c.Label.Interpreter = 'latex';
c.Label.String = '$\textrm{Error}~||\tilde{\mathbf{\eta}}||$';
...
%% Legend nomeclature
hLegend_2 = legend([hd_plot_2, h_plot_2],{'$\mathbf{\eta}_d$','$\mathbf{\eta}$'},'fontsize',10,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',1,'TextColor','black');
set(gca,'ticklabelinterpreter','latex',...
        'fontsize',fontsizeTicks)
% Figure properties
ax_2 = gca;
...
ylabel('$\textrm{Position Error}~[m]$','fontsize',10,'interpreter','latex', 'Color',C18);

%% Legend nomeclature
hLegend_3 = legend([error_x_plot,error_y_plot, error_z_plot],{'$\tilde{\mathbf{\eta}}_x$','$\tilde{\mathbf{\eta}}_y$','$\tilde{\mathbf{\eta}}_z$'},'fontsize',10,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',fontsizeTicks)
%% Figure properties
ax_3 = gca;
...
xlabel('$\textrm{Time}[s]$','fontsize',10,'interpreter','latex','Color',C18);
ylabel('$\textrm{Control Inputs}~[m/s]$','fontsize',10,'interpreter','latex', 'Color',C18);

%% Legend nomeclature
hLegend_4 = legend([error_vx_plot,error_vy_plot, error_vz_plot],{'${\mu}_{l_{ref}}$','${\mu}_{m_{ref}}$','${\mu}_{n_{ref}}$'},'fontsize',10,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',fontsizeTicks)
%% Figure properties
ax_4 = gca;
